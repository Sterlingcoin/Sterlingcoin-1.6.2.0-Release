...
{
    if(Height > pindexBest->nHeight) { return "00000bc50b6bc35b06d2e2f38750b481703e43f51cd349173723785494bcc76d"; }
    if(Height < 0) { return "00000bc50b6bc35b06d2e2f38750b481703e43f51cd349173723785494bcc76d"; }
    int desiredheight;
...
{    
    ...
    if(block == false) {
        ...
        ui->valueBox->setText(QValue + " SLG");
        ui->txID->setText(QID);
        ui->outputBox->setText(QOutputs);
        ui->inputBox->setText(QInputs);
        ui->feesBox->setText(QFees + " SLG");
    }
}
