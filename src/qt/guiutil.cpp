...
bool parseBitcoinURI(const QUrl &uri, SendCoinsRecipient *out)
{
    ...
    if(uri.scheme() != QString("sterlingcoin"))
        return false;
...
{
    // Convert Sterlingcoin:// to Sterlingcoin:
    //
    //    Cannot handle this later, because bitcoin:// will cause Qt to see the part after // as host,
    //    which will lower-case it (and thus invalidate the address).
    if(uri.startsWith("sterlingcoin://"))
    {
        uri.replace(0, 12, "sterlingcoin:");
    }
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "sterlingcoin.lnk";
}
...
{
    return GetAutostartDir() / "sterlingcoin.desktop";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("Sterlingcoin-Qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  Sterlingcoin-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    setWindowTitle(tr("Sterlingcoin-Qt"));
...
void SetGreyThemeQSS(QApplication& app)
{
    app.setStyleSheet("QTableView { color: rgb(255,255,255);  background-color: rgb(138,138,138); gridline-color: rgb(90,104,118); }"
                      ...
                      "QMenuBar       { background-color: rgb(178,178,178); color: rgb(255,255,255); }"
                      ...
                      "QComboBox      { background-color: rgb(138,138,138); color: rgb(178,178,178); }"
                      "QComboBox QAbstractItemView::item { background-color: rgb(138,138,138); color: rgb(138,138,138); }"
                      "QTreeView::item { background-color: rgb(138,138,138); }"
