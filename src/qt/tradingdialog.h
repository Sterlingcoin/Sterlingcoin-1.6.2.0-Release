...
private slots:
    ...
    void on_BuySLG_clicked();
    void on_SellSLGBTN_clicked();
    void on_SellBidcomboBox_currentIndexChanged(const QString &arg1);
    void on_Sell_Max_Amount_clicked();
    void on_UnitsInputSLG_textChanged(const QString &arg1);
    ...
    QString BuySLG(QString OrderType, double Quantity, double Rate);
    QString SellSLG(QString OrderType, double Quantity, double Rate);
